...
imageshifting.to(".rimg2i", {
    ...
    x: isMobile ? "150%" : "125%",
    y: isgrtlaptop ? "9%" : istab ? "-0%" : isMobile ? "60%" : "8%",
    duration: 1,
    ease: "power2.out"
}).to(".rimg3i", {
    x: isgrtlaptop ? "-126%" : istab ? "-72%" : isMobile ? "-118%" : "-84%",
    y: isMobile ? "100%" : "-15%",
    // width: isMobile ? "110%" : "",
    duration: 1,
    ease: "power2.out"
...
},{}]},["hF8lp","igcvL"], "igcvL", "parcelRequirefd8f")
